...
def build_summary_prompt(language="en"):
    """Build the system prompt for patient-friendly summary generation."""
    lang_instruction = ""
    if language != "en":
        lang_instruction = (
            f"Write the entire summary in {language}. "
...
def build_extraction_prompt():
    """Build the system prompt for clinical data extraction from transcripts."""
    return (
